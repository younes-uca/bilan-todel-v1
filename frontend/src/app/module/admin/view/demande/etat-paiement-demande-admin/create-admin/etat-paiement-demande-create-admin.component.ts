...
@Component({
  selector: 'app-etat-paiement-demande-create-admin',
  templateUrl: './etat-paiement-demande-create-admin.component.html'
})
export class EtatPaiementDemandeCreateAdminComponent extends AbstractCreateController<EtatPaiementDemandeDto, EtatPaiementDemandeCriteria, EtatPaiementDemandeService>  implements OnInit {
