...
public class VenteRestAdmin  extends AbstractController<Vente, VenteDto, VenteHistory, VenteCriteria, VenteHistoryCriteria, VenteAdminService, VenteConverter> {
    ...
    public HttpEntity<byte[]> createPdf(@RequestBody VenteDto dto) throws Exception{
    ...
    @ApiOperation("find by etatVente id")
    @GetMapping("etatVente/id/{id}")
    public List<Vente> findByEtatVenteId(@PathVariable Long id){
        return service.findByEtatVenteId(id);
    }
    @ApiOperation("delete by etatVente id")
