...
public class EtatPaiementAchat   extends AuditBusinessObject     {
    ...
    public EtatPaiementAchat(){
        super();
    }

    public EtatPaiementAchat(Long id,String libelle){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        EtatPaiementAchat etatPaiementAchat = (EtatPaiementAchat) o;
        return id != null && id.equals(etatPaiementAchat.id);
    }
