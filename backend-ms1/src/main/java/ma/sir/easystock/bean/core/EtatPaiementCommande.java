...
public class EtatPaiementCommande   extends AuditBusinessObject     {
    ...
    public EtatPaiementCommande(){
        super();
    }

    public EtatPaiementCommande(Long id,String libelle){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        EtatPaiementCommande etatPaiementCommande = (EtatPaiementCommande) o;
        return id != null && id.equals(etatPaiementCommande.id);
    }
